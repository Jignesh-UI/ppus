...
export default function CurrentOffersModelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CurrentOffersModel(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CurrentOffersModelCreateForm")}
      {...rest}
    >
      <Flex
