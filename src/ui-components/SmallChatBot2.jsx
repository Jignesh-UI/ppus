...
export default function SmallChatBot2(props) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "SmallChatBot2")}
      {...rest}
    >
      <View
        width="342px"
        ...
        left="0px"
        padding="0px 0px 0px 0px"
        backgroundImage="linear-gradient(6deg, rgba(232,84,44,1), rgba(232,84,44,0.75), rgba(232,84,44,0.75))"
        {...getOverrideProps(overrides, "Rectangle 348")}
      ></View>
      <View
        padding="0px 0px 0px 0px"
        width="22px"
        ...
        top="180px"
        left="278px"
        {...getOverrideProps(overrides, "dp +msg'")}
      >
        <View
          padding="0px 0px 0px 0px"
          width="22px"
          ...
          top="0px"
          left="0px"
          {...getOverrideProps(overrides, "msg2")}
        >
          <Text
            fontFamily="Lato"
            fontSize="16px"
        ...
        >
          ...
          >
            <Icon
              ...
              left="0%"
              right="-0.01%"
              {...getOverrideProps(overrides, "Vector36146")}
            ></Icon>
          </View>
        </View>
        <Icon
        ...
        >
          ...
          >
            <Icon
              ...
              left="-2.5%"
              right="2.5%"
              {...getOverrideProps(overrides, "Vector36151")}
            ></Icon>
          </View>
        </Flex>
        <Flex
        ...
        >
          ...
          >
            <Icon
              ...
              left="8.33%"
              right="16.67%"
              {...getOverrideProps(overrides, "Vector36158")}
            ></Icon>
            <Icon
              width="8.24px"
              height="8.24px"
              ...
              left="33.33%"
              right="7.83%"
              {...getOverrideProps(overrides, "Vector36159")}
            ></Icon>
          </View>
          <View
            width="14px"
          ...
          >
            <Icon
              ...
              left="14.29%"
              right="28.57%"
              {...getOverrideProps(overrides, "Vector36161")}
            ></Icon>
            <Icon
              width="7px"
              height="8px"
              ...
              {...getOverrideProps(overrides, "Vector36162")}
            ></Icon>
          </View>
          <Icon
            width="8px"
      ...
      >
        ...
        >
          <Icon
            ...
            left="12.5%"
            right="12.5%"
            {...getOverrideProps(overrides, "Vector36168")}
          ></Icon>
          <Icon
            width="3.91px"
            height="2.15px"
            ...
            left="29.17%"
            right="29.17%"
            {...getOverrideProps(overrides, "Vector36169")}
          ></Icon>
          <Icon
            width="0px"
            height="5.16px"
            ...
            left="50%"
            right="50%"
            {...getOverrideProps(overrides, "Vector36170")}
          ></Icon>
        </View>
      </View>
      <Flex
      ...
      >
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "open-external-link-icon 1")}
        >
          <Flex
            padding="0px 0px 0px 0px"
            width="16px"
          ...
          >
            <Icon
              ...
              left="0%"
              right="0%"
              {...getOverrideProps(overrides, "Vector36173")}
            ></Icon>
          </Flex>
        </Flex>
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "chevron-dropdown")}
        >
          <Icon
            width="12.47px"
            height="5.67px"
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "Vector36141")}
          ></Icon>
        </Flex>
      </Flex>
    </View>
